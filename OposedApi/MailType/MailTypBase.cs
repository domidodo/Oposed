...
namespace OposedApi.MailType
{
    ...
    internal abstract class MailTypBase
    {
        ...
        internal abstract string GetSubject(string lang);
        protected abstract string BildContent(string lang);
        ...
        internal string GetHtmlContent(string lang)
        {
            var sb = new StringBuilder();
            sb.Append(GetHtmlHeader());
            sb.Append(BildContent(lang));
